defmodule VutuvWeb.Router do
  ...
  scope "/settings", VutuvWeb do
    ...
    put("/feed_replies", SettingsController, :update_feed_replies)
    patch("/feed_replies", SettingsController, :update_feed_replies)
    post("/feed_replies/reset", SettingsController, :reset_feed_replies)
